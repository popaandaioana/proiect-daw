...
<h3>Cele mai noi aparitii</h3><br>
</td>
</tr>
<?php
$sql = "SELECT carti.id_carte, carti.titlu_carte, autori.nume_autor, carti.pret, carti.promotie
FROM carti, autori, sunt_scrise 
WHERE carti.id_carte = sunt_scrise.id_carte AND autori.id_autor = sunt_scrise.id_autor
ORDER BY carti.data_aparitie_lib DESC LIMIT 0,9";
