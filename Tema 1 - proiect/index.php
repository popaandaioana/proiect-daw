...
Dorim ca vizitatorii sa cumpere carti, la fel ca intr-un magazin real. Ei vor putea sa se plimbe prin spatial virtual, sa vada copertele cartilor si detalii despre acestea, sa-si puna fiecare carte intr-un cos de cumparaturi si la sfarsit sa se duca la casa pentru a plati. Fiecare carte va fi insotita si de o scurta descriere, deoarece nu vom avea un librar care sa faca acest lucru pentru noi. La fel ca intr-o librarie, cartile vor fi aranjate dupa domeniul caruia ii apartin. Vom pune la dispozitia vizitatorilor un motor de cautare pentru a gasi rapid ceea ce ii intereseaza, fara a fi nevoiti sa piarda timp pretios cautand prin rafturi.
</p>
</div>
...
<li>Vizualizare sugestii (promotii, noutati, top vanzari)</li>
