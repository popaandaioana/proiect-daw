<?php
 ...
 include ("autorizare.php");
	...
	include ("meniu.php");
?>
<div class="col-9" class="table-responsive">
<h5>Comenzi</h5>
<b>Comenzile mele onorate: </b>
...
<?php
	$sqlComenziUser="SELECT comenzi.id_comanda, DATE_FORMAT(comenzi.data_comanda,'%d-%m-%y') as data_comanda,
	     ...
	     FROM comenzi,useri
	     WHERE comenzi.id_user=".$_SESSION['id_user']." AND useri.id_user=".$_SESSION['id_user']." 
	     AND comenzi.comanda_onorata=1";
